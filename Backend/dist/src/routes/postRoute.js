...
postRouter.get('/getAll', async (req, res) => {
    try {
        ...
        posts = await app_1.prisma.post.findMany(findManyOptions);
...
postRouter.get('/getFeed/:userId', async (req, res) => {
    try {
...
postRouter.get('/getPostsByCelebrity/:celebrityId', async (req, res) => {
    try {
